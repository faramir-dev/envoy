...
public:
  ...
  Http::FilterHeadersStatus decodeHeaders(Http::RequestHeaderMap& headers,
    ...
    // This is definitivelly not a comprehensive solution, but it is a simple
    // and effective one. It would be possible to include cookies in the cache
    // key, but that would require a more sophisticated key configuration and
    // would likely result in a very low cache hit rate.
